...
open class Element: Node {
    ...
    /**
     * Find elements that match the {@link SelectorSoup} CSS query, with this element as the starting context. Matched elements
     ...
     * </ul>
     * <p>
     * See the query syntax documentation in {@link org.jsoup.select.SelectorSoup}.
     * </p>
     *
     * @param cssQuery a {@link SelectorSoup} CSS-like query
     * @return elements that match the query (empty if none match)
     * @see org.jsoup.select.SelectorSoup
     * @throws SelectorSoup.SelectorSoupParseException (unchecked) on an invalid CSS query.
     */
    public func select(_ cssQuery: String)throws->Elements {
        return try SelectorSoup.select(cssQuery, self)
    }
    
    /**
     * Check if this element matches the given {@link SelectorSoup} CSS query.
     * @param cssQuery a {@link SelectorSoup} CSS query
     ...
     */
    public func cssSelectorSoup()throws->String {
        ...
        return try parent()!.cssSelectorSoup() + (selector.toString())
    }
