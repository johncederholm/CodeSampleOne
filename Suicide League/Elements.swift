...
open class Elements: NSCopying {
	...
	* @param query A {@link SelectorSoup} query
	* @return the filtered list of elements, or an empty list if none match.
	*/
	open func select(_ query: String)throws->Elements {
		return try SelectorSoup.select(query, this)
	}

	/**
	* Remove elements from this list that match the {@link SelectorSoup} query.
	* <p>
	...
	*/
	open func not(_ query: String)throws->Elements {
		let out: Elements = try SelectorSoup.select(query, this)
		return SelectorSoup.filterOut(this, out.this)
	}
